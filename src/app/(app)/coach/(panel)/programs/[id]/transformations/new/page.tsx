...
export const metadata: Metadata = { title: "Nueva transformación — EPHA" }
  ...
  return (
    <div className="flex flex-col gap-5">
      <div className="flex flex-col gap-3">
        ...
        <h1 className="text-2xl font-bold tracking-tight">Nueva transformación</h1>
      </div>
      <TransformationForm programId={id} />
    </div>
  )
}
